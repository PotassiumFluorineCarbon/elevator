...
#define ID                  CC // set personality of this program for one controller
...
int main(void)
{
	...
	while (1)
	{
		...
		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, (Floor1Pending) ? GPIO_PIN_SET : GPIO_PIN_RESET);

		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_6, (Floor2Pending) ? GPIO_PIN_SET : GPIO_PIN_RESET);
