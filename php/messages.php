...
<body class="control-panel">
    ...
    <nav class="container mb-4">
        <ul class="nav nav-pills justify-content-center bg-white py-2 rounded shadow">
            <li class="nav-item">
                <a class="nav-link text-dark" href="controlPanel.php">Control Panel</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" href="diagnostics.php">Diagnostics</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active bg-dark text-white" href="messages.php">Messages</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-dark" href="member.php">Members</a>
            </li>
            <li class="nav-item">
