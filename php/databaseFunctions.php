...
function updateField(
    ...
    // Whitelist of allowed fields to prevent SQL Injection (excluding PK 'nodeID')
    ...
    // Build query dynamically with the validated field name
...
function insert(
    ...
    $query = 'INSERT INTO elevatorNetwork (NodeName, nodeType, NetworkType, Status)
              VALUES (:NodeName, :nodeType, :NetworkType, :Status)';

    $statement = $db->prepare($query);
    $statement->bindValue('NodeName', $NodeName);
    $statement->bindValue('nodeType', $nodeType);
    $statement->bindValue('NetworkType', $NetworkType);
...
function update(
    ...
    $statement = $db->prepare($query);
    $statement->bindValue('NodeName', $new_NodeName);
    $statement->bindValue('nodeType', $new_nodeType);
    $statement->bindValue('NetworkType', $new_NetworkType);
    $statement->bindValue('Status', $new_Status);
...
function clearDiagnostic(
    ...
    $query = "DELETE FROM Diagnostics WHERE DiagnosticID = :id";
...
function clearMessages(
    ...
    $query = "DELETE FROM CAN_messages WHERE MessageID = :id";
